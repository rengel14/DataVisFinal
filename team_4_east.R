    ...
    output$schoolsMap <- renderLeaflet({
        leaflet() %>% 
            ...
            addPolygons(data=council.subset(),
                    ...
                    popup = paste("Council District: <b>",council.subset()$Num,"</b><br>",
                                   "Council Member: <b>",council.subset()$Council_Me,"</b><br>",
                                   "Total Area (Sq. Miles): <b>",council.subset()$isect_area_sqmi,"</b>",
                                   "<hr class='plot_hr'>Total Population: <b>",council.subset()$population,"</b><br>",
                                   "Pop Density: <b>",council.subset()$pop_density,"</b>",
                                   "<hr class='plot_hr'>Households: <b>",council.subset()$households,"</b><br>",
                                   "Total Housing Units: <b>",council.subset()$housing_units,"</b><br>",
                                   "Occupied Housing Units: <b>",council.subset()$housing_units_occupied,"</b><br>",
                                   sep =""),
            ...
            addPolygons(data=council_schools.subset(),
                    layerId = ~School,
                    popup = paste("School Name: <b>",council_schools.subset()$School,"</b><br>",
                                  "School Type: <b>",council_schools.subset()$SchoolType,"</b>",
                                  "<hr class='plot_hr'>Council District: <b>",council_schools.subset()$Num,"</b><br>",
                                  "Council Member: <b>",council_schools.subset()$Council_Me,"</b>",
                                  sep =""),
                    labelOptions = labelOptions(textsize = "12px"), 
                    group = ~SchoolType,
                    color = "#0c2340",
